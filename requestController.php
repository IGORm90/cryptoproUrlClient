...
class RequestController {
    ...
    public function sendRequest($xmlString, $functionId){
        ...
        try {
            ...
            curl_setopt($ch, CURLOPT_URL, $this->serverAddres);
    ...
    public function getCryptoProPath(){
    ...
    public function makePostCommand($xmlString, $functionId){

        $cryptoProPath = $this->getCryptoProPath();
    ...
    public function checkServerError($serverAnswerString){
        ...
        if($pos){
            return $this->page_title($serverAnswerString);
        }
        return false; 
    }

    public function page_title($htmlString) {
